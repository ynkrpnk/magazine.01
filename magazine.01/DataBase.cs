...
namespace magazine._01
{
    class DataBase
    {
        ...
        //public static string MdfFilePath = @"C:\Users\Михайло\Desktop\Уник\3 семестр\алг та сд\Курсач\Database1.mdf";
        ...
        SqlConnection con = new SqlConnection($@"Data Source=(LocalDB)\MSSQLLocalDB;Database={DatabaseName};Integrated Security=True;Connect Timeout=30");
